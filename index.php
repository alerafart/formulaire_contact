                    ...
                    <form id="contact-form" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>" role="form">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" id="phone" name="phone" class="form-control" placeholder="Votre Téléphone" value="<?php echo $phone; ?>">
                                <p class="comments">Message d"erreur</p>
                            </div>
                            ...
                            <p class="thank-you">Votre message a bien été envoyé. Merci de m'avoir contactée</p>
                        </div>
